...
| `mt-creative-yonetmeni` | 1. "Reels reklamı için video üret" → ✅ tetiklenmeli<br>2. "5 image varyantı çıkar, A/B test için" → ✅ tetiklenmeli<br>3. "Hook copy'sini yaz, problem-first" → ✅ tetiklenmeli<br>4. "Mevcut creative'in revizyonu, logo büyüsün" → ✅ tetiklenmeli<br>5. "Shotstack ile outro ekle" → ✅ tetiklenmeli<br>6. "Paywall hero görseli üret" → ✅ tetiklenmeli (app içi banner)<br>7. "10 text overlay varyantı bulk render" → ✅ tetiklenmeli<br>8. "Brand video + caption + logo" → ✅ tetiklenmeli<br>9. "TikTok için UGC creator bulmama yardım et" → ❌ tetiklenmemeli (bu sistem dışı — creator outreach yapmıyoruz)<br>10. "App Store screenshot tasarla" → ❌ tetiklenmemeli (`mt-aso-uzmani`)<br>11. "Meta'da kampanya kur" → ❌ tetiklenmemeli (`mt-meta-ads-uzmani`)<br>12. "Hangi creative scale edilmeli?" → ❌ tetiklenmemeli (`mt-kampanya-analisti`)<br>13. "Paywall UI tasarla" → ❌ tetiklenmemeli (bu sistem dışı)<br>14. "fal.ai için yeni API key" → ❌ tetiklenmemeli (`mt-entegrasyon-kurucu`)<br>15. "Hangi kanaldan başlamalıyım?" → ❌ tetiklenmemeli (`mt-paid-ua-uzmani`) |
