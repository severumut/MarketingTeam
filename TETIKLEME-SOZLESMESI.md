...
| "Creative üret" / "reklam görseli" | Brand-produced paid creative (Meta/TikTok/Google asset) → `mt-creative-yonetmeni` | UGC creator content / organik → `mt-content-uretici`; App Store screenshot → `mt-aso-uzmani` |
| "Video üret" | Reklam (paid) — `mt-creative-yonetmeni` | Organik TikTok/Reels native → `mt-content-uretici` |
...
| "Hook" / "ad copy" / "headline" | Paid reklam metni → `mt-creative-yonetmeni` | Organik video script → `mt-content-uretici` |
